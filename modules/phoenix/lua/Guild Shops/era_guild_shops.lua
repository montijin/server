...
patchStock('Bornahn', xi.item.WORKSHOP_ANVIL,          { initial = 120 })
...
patchStock('Wahnid', xi.item.BALL_OF_SARDINE_PASTE,   { initial = 120 })
patchStock('Wahnid', xi.item.BALL_OF_CRAYFISH_PASTE,  { initial = 120 })
patchStock('Wahnid', xi.item.BALL_OF_INSECT_PASTE,    { initial = 120 })
patchStock('Wahnid', xi.item.BALL_OF_TROUT_PASTE,     { initial = 120 })
patchStock('Wahnid', xi.item.MEATBALL,                { initial = 120 })
patchStock('Wahnid', xi.item.SLICE_OF_SARDINE,        { initial = 120 })
patchStock('Wahnid', xi.item.SLICE_OF_COD,            { initial = 120 })
patchStock('Wahnid', xi.item.PEELED_LOBSTER,          { initial = 120 })
patchStock('Wahnid', xi.item.SLICE_OF_BLUETAIL,       { initial = 120 })
patchStock('Wahnid', xi.item.PEELED_CRAYFISH,         { initial = 120 })
patchStock('Wahnid', xi.item.SLICE_OF_MOAT_CARP,      { initial = 120 })
patchStock('Wahnid', xi.item.FLY_LURE,                { initial = 120 })
patchStock('Wahnid', xi.item.MINNOW,                  { initial = 120 })
patchStock('Wahnid', xi.item.WORM_LURE,               { initial = 120 })
patchStock('Wahnid', xi.item.SABIKI_RIG,              { initial = 120 })
patchStock('Wahnid', xi.item.WILLOW_FISHING_ROD,      { initial =  90 })
patchStock('Wahnid', xi.item.YEW_FISHING_ROD,         { initial =  90 })
patchStock('Wahnid', xi.item.BAMBOO_FISHING_ROD,      { initial =  90 })
patchStock('Wahnid', xi.item.FASTWATER_FISHING_ROD,   { initial =  60 })
patchStock('Wahnid', xi.item.TARUTARU_FISHING_ROD,    { initial =  30 })
patchStock('Wahnid', xi.item.MITHRAN_FISHING_ROD,     { initial =  30 })
patchStock('Wahnid', xi.item.CLOTHESPOLE,             { initial =  30 })
patchStock('Wahnid', xi.item.SINGLE_HOOK_FISHING_ROD, { initial =  30 })
